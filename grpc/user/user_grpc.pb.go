...
func (c *userServiceClient) ListUsers(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
...
func (UnimplementedUserServiceServer) ListUsers(context.Context, *empty.Empty) (*Users, error) {
